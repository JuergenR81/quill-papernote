...
- Reporting new [bugs](https://github.com/quill-next/quill-next/labels/bug) or adding details to existing ones
- Reproducing [unconfirmed bugs](https://github.com/quill-next/quill-next/labels/needs%20reproduction)
- Quick typo fix or documentation improvement [Pull Requests](#pull-requests)
- Participating in [discussions](https://github.com/quill-next/quill-next/discussions)
...
- Helping fix [bugs](https://github.com/quill-next/quill-next/labels/bug)
- Implementing new [features](https://github.com/quill-next/quill-next/labels/feature)
...
a [discussion](https://github.com/quill-next/quill-next/discussions) to ensure your work aligns with the project's goals and direction.

## Questions

If you have a question, it is best to ask on [Discussions](https://github.com/quill-next/quill-next/discussions) under the Q&A category.

## Bug Reports

Search through [Github Issues](https://github.com/quill-next/quill-next/issues) to see if the bug has already been reported. If so, please comment with any additional information.
...
Search through [Github Issues](https://github.com/quill-next/quill-next/labels/feature) to see if someone has already suggested the feature. If so, please provide support with a [reaction](https://github.com/blog/2119-add-reactions-to-pull-requests-issues-and-comments) and add your own use case.
...
Please check to make sure your plans fall within Quill's scope. This often means opening up a [discussion](https://github.com/quill-next/quill-next/labels/discussion).
...
1. Be forked off the [main](https://github.com/quill-next/quill-next/tree/main) branch.
...
**Important:** By issuing a Pull Request you agree to allow the project owners to license your work under the terms of the [License](https://github.com/quill-next/quill-next/blob/main/LICENSE).
